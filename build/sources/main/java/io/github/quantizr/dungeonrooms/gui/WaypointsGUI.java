...
public class WaypointsGUI extends GuiScreen {
    ...
    private GuiButton enableCustom;
    ...
    public void initGui() {
        ...
        enableCustom = new GuiButton(9, width / 2 - 100, (height / 6) * 5 - 200, 200, 20, "Customs: " + getOnOff(Waypoints.customWaypointsOn));
        ...
        this.buttonList.add(enableCustom);
    ...
    public void actionPerformed(GuiButton button) {
        ...
        else if (button == enableCustom) {
            Waypoints.customWaypointsOn = !Waypoints.customWaypointsOn;
            ConfigHandler.writeBooleanConfig("waypoint", "customWaypointsOn", Waypoints.customWaypointsOn);
            button.displayString = "Customs: " + getOnOff(Waypoints.customWaypointsOn);
        }
